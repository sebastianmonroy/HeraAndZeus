...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// 
	/// Generated by Infer.NET 2.3 beta 4 at 10:47 AM on Sunday, April 27, 2014.
	/// </remarks>
	public class Model_EP : IIterativeProcess
	{
		...
		// Messages from uses of 'bothHeads'
		public Bernoulli[] bothHeads_uses_B;
		// Message from definition of 'bothHeads'
		public Bernoulli bothHeads_F;
		// Message to marginal of 'bothHeads'
		public Bernoulli bothHeads_marginal_B;
		...
		public void Reset()
		{
			...
			// Create array for 'bothHeads_uses' backwards messages.
			this.bothHeads_uses_B = new Bernoulli[0];
			this.bothHeads_F = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
			...
			this.bothHeads_F = BooleanAndOp.AndAverageConditional(this.firstCoin_uses_F[0], this.secondCoin_uses_F[0]);
		}
		...
		{
			this.bothHeads_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
			...
			this.bothHeads_marginal_B = ReplicateOp.MarginalAverageConditional<Bernoulli>(this.bothHeads_uses_B, this.bothHeads_F, this.bothHeads_marginal_B);
		}
		...
		{
			return this.bothHeads_marginal_B;
		}
