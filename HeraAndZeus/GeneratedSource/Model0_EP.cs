...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// 
	/// Generated by Infer.NET 2.3 beta 4 at 11:38 AM on Sunday, April 27, 2014.
	/// </remarks>
	public class Model0_EP : IIterativeProcess
	{
		...
		public void Reset()
		{
			...
			this.firstCoin_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli1);
			// Message to 'firstCoin' from Random factor
			this.firstCoin_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli1);
			...
			this.secondCoin_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli0);
			// Message to 'secondCoin' from Random factor
			this.secondCoin_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli0);
		...
		{
			this.firstCoin_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli1);
			for(int _ind0 = 0; _ind0<1; _ind0++)
			{
				this.firstCoin_uses_B[_ind0] = ArrayHelper.MakeUniform<Bernoulli>(this.vBernoulli1);
			}
			this.secondCoin_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli0);
			for(int _ind0 = 0; _ind0<1; _ind0++)
			{
				this.secondCoin_uses_B[_ind0] = ArrayHelper.MakeUniform<Bernoulli>(this.vBernoulli0);
			}
			for(int _ind0 = 0; _ind0<1; _ind0++)
			{
				this.secondCoin_uses_F[_ind0] = ArrayHelper.MakeUniform<Bernoulli>(this.vBernoulli0);
			}
			...
			for(int _ind0 = 0; _ind0<1; _ind0++)
			{
				this.firstCoin_uses_F[_ind0] = ArrayHelper.MakeUniform<Bernoulli>(this.vBernoulli1);
			}
